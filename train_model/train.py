...
if __name__ == "__main__":
    local = False
    tracking_server_url="https://user-pengfei-134963.user.lab.sspcloud.fr/"
    ...
    if local:
        ...
        csv_url = (
            "https://raw.githubusercontent.com/pengfei99/mlflow-pokemon-example/master/data/winequality-red.csv"
        )
    try:
